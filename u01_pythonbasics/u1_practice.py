...
name = "Alice"
hobby = "reading"
sentence = name + " loves " + hobby + " in her free time."
print(sentence)
"""
...
"""
cheer = "Let's go! "
print(cheer * 3 + "We can do it!")
"""

# U1 - Exercise 4
# Write a program to manually display a triangle of stars using the print statement.
# You must use the "string" * x, where x is a number to multiply your strings.
# Example Output:
# *
# **
# ***
...
# U1 - Exercise 5
# Write a program to display a centered triangle of stars with 5 rows
# # Example Output:
#     *    
#    ***  
#   *****
#  *******
# *********
# Hint: Use spaces and stars with string concatenation (+).
